...
public class GameManager : NetworkBehaviour
{
    ...
    {
        // 게임 도중에 플레이어가 나가면 게임을 종료하고 메뉴로 돌아감
        if (IsGameActive)
        {
            ExitGame();
        }
    ...
    private void SpawnPlayer()
    {
        ...
        for (var i = 0; i < 2; i++)
        {
            ...
            // 각 클라이언트 ID에 해당 클라이언트가 몇 번째 플레이어인지를 매핑
    ...
    private void SpawnBall()
    {
        ...
        var ballGameObject = Instantiate(ballPrefab, Vector3.zero, Quaternion.identity);
